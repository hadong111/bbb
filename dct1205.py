...
def fakeEmail():
  faker = Faker()
  print ('')
  print ('             \033[1;34m[ TOOL ĐÀO EMAIL BY DCT ]')
  print ('')
  data_kytu = ['', '_', '.']
  so_luong = int(input(" \033[1;34m---𒁵 Số Lượng Mail Muốn Đào : "))
  Domain = input(" \033[1;34m---𒁵 Nhập Domain(vd: yahoo) : ")
  file_email = input(" \033[1;34m---𒁵 Nhập File Lưu Mails(vd: email.txt) : ")
  n = 0
  for fake in range(so_luong):
    ...
    print (" [" + str(n) + "] ---𒁵 |DCTCUTE|" + fake_email)
...
def checkhotmail():
  ...
  print ('')
  try:
    print (" \033[1;34m---𒁵 CÓ THỂ NHẬP ĐỊNH DẠNG MAIL|PASS")
    hotmail = open(input(" \033[1;34m---𒁵 Nhập File Chứa Hotmail(vd: hotmail.txt) : ")).readlines()
    hotmail_die = input(" \033[1;34m---𒁵 Nhập File Lưu Hotmail Die(hotmaildie.txt) : ")
    hotmail_live = input(" \033[1;34m---𒁵 Nhập File Lưu Hotmail Live(hotmaillive.txt) : ")
  except:
    print (" \033[1;31mĐÉO TÌM THẤY FILE MÀY ĐÃ NHẬP !")
    quit()
  list_hotmail = []
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print (" \033[1;31m---𒁵 |\033[1;37mDCTCUTE\033[1;31m|Email Live|" + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print (" \033[1;32m---𒁵 |\033[1;37mDCTCUTE\033[1;32m|Email Die|" + hot_mail + "@hotmail.com")
...
def checkyahoo():
  ...
  try:
    print (" \033[1;34m---𒁵 CÓ THỂ NHẬP ĐỊNH DẠNG MAIL|PASS")
    n_yahoo = 0
    yahoo = open(input(" \033[1;34m---𒁵 Nhập File Chứa Yahoo(ex: yahoo.txt) : ")).readlines()
    yahoo_die = input(" \033[1;34m---𒁵 Nhập File Lưu Yahoo Die(ex: yahoodie.txt) : ")
    yahoo_live = input(" \033[1;34m---𒁵 Nhập File Lưu Yahoo Live(ex: yahoolive.txt) : ")
  except:
    print (" \033[1;31mĐÉO TÌM THẤY FILE MÀY ĐÃ NHẬP !")
    quit()
  list_yid = []
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print(" \033[1;32m---𒁵 |\033[1;37mDCT CUTE\033[1;32m|Email Die| " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(" \033[1;31m---𒁵 |\033[1;37mDCT CUTE\033[1;31m|Email Live| " + yid + "@yahoo.com")
...
def checkvalid():
  print ('')
  print ('             \033[1;34m[ DCT DZ BY TOOL  ]')
  print ('')
  try:
    print (" \033[1;93m---𒁵 LƯU Ý :")
    print ("   \033[1;93m•DÉO HỖ TRỢ ĐỊNH DẠNG MAIL|PASS")
    print ("   \033[1;93m•TOOL CHẠY ĐA LUỒNG ĐỒNG NGHĨA VỚI IP CỦA M SẼ DỄ BỊ FB BLOCK HƠN")
    print ("   \033[1;93m•VUI LÒNG FAKE IP TRƯỚC CHẠY TOOL NÀY")
    print ("   \033[1;93m•MỖI IP CHECK ĐƯỢC 50-80 MAIL RỒI ĐỔI IP KHÁC")
    fileEmail = open(input(" \033[1;34m---𒁵 Nhập File Chứa Email(ex: email.txt) : ")).readlines()
    valid = input(" \033[1;34m---𒁵 Nhập File Lưu Email Valid Facebook(ex: validfb.txt) : ")
  except:
    print (" \033[1;31mĐÉO TÌM THẤY FILE MÀY ĐÃ NHẬP !")
    quit()
  list_email_fb = []
  ...
  def run_check_valid(emailfb):
    ...
    if kq_check == None:
      print (" \033[1;32m---𒁵 |\033[1;37mDCTCUTE\033[1;32m| Có Liên Kết |" + emailfb)
      open(valid,"a").write(emailfb + "\n")
    else:
      print (" \033[1;31m---𒁵 |\033[1;37mDCTCUTE\033[1;31m| Không Liên Kết |" + emailfb)
  with concurrent.futures.ThreadPoolExecutor() as executor:
...
def logo():
  ...
  \033[1;36m________________________   ___________________________ 
\033[1;36m___  __ \_  ____/__  __/   ___  __/_  __ \_  __ \__  / 
\033[1;36m__  / / /  /    __  /      __  /  _  / / /  / / /_  /  
\033[1;36m_  /_/ // /___  _  /       _  /   / /_/ // /_/ /_  /___
\033[1;36m/_____/ \____/  /_/        /_/    \____/ \____/ /_____/
                                                       

  
       
   𖣘 ⋆͙̈\033[1;34m𖤓 FB https://www.facebook.com/1205.info 
     
      \033[1;34m𖤓 Copyright By : Doan Chien Thuan\033[1;91m 
      
      \033[1;36m𖤓 Youtube : 𝘿𝙤𝙖𝙣 𝘾𝙝𝙞𝙚𝙣 𝙏𝙝𝙪𝙖𝙣 𓆉\033[1;35m 
...
|==================================|
|\033[1;93m𖤓 RENAME INBOX ZALO 0353366961\033[1;35m       |
|\033[1;36m███████████\033[1;91m           
|  
|\033[1;93m𝑻𝒉𝒊𝒔 𝒊𝒔 𖤓 𝑫𝒐𝒂𝒏 𝑪𝒉𝒊𝒆𝒏 𝑻𝒉𝒖𝒂𝒏 𓂄𓆩𖤓𓆪𓂁\033[1;35m      
|==================================|
                
                
                 \033[0;33m Tool By :DOAN CHIEN THUAN
                 

                 \033[1;31m Donate Me: Momo: 0353366961                             
"""
...
\033[1;37m[-------------------------------]
                      \033[1;31m.1 Tool Đào All Mail.
                      
                      \033[1;32m.2 Tool Check Hotmail.
                      
                      \033[1;33m.3 Tool Check Yahoo.
                      
                      \033[1;34m.4 Tool Check LK Facebook.
                      
                      \033[1;35m.5 EXIT Tool.
                \033[1;37m[-------------------------------]
...
"""
  for letter in menu:
  	...
  	sys.stdout.flush()
  	time.sleep(0.001)
  choice_user = input("\033[1;36m𒈶𒁵 Nhập Lựa Chọn : ")
  if choice_user == '1':
    clear()
    fakeEmail()
  if choice_user == '2':
